...
const favProjects = [
  {
    image: '/img/projects/cashrhythm.png',
    title: 'CashRhythm',
    category: 'NextJS - Redux - Typescript - Tailwind CSS',
    repo: 'https://github.com/cresxjohn/cashrhythm',
    link: 'https://app.cashrhythm.cresxjohn.com/'
  }
];
