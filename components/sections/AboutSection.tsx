      ...
      <div className="w-full flex flex-col gap-6">
        ...
        <AnimationContainer customClassName="w-full flex flex-col gap-5 mb-8">
          <p className="text-base text-gray-400">
            ...
            learning the path to be a DevOps and master tools or practices such
            as "Linux, AWS, CI/CD, Docker, Kubernetes, Jenkins and Terraform" to
            perform cost optimized, reliable and secure full software delivery
            and maintenance.
          </p>
          ...
          <p className="text-base text-gray-400">
            ...
            Next.js, Angular, Ionic, and Electron". I also have skills in
